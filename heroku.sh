...
SAIBA QUE DEVES DÁ OS COMANDOS BÁSICOS DO TERMUX, SENÃO NEM VENHA DÁ OS COMANDOS PRA LANÇAR PRO HEROKU QUE VAI DAR ERROR
...
git init
clear
echo ${CYAN}'Digite o nome da pasta da api, caso a pasta esteja em
download escreva assim Download/PastaDaApi

Obs: Caso a pasta da api esteja em MAIÚSCULO digite o 
nome da pasta da api em MAIÚSCULO'
echo ${WHITE}
read NOMEDAPASTA
